...
const MobileMenu = () => {
 ...
 const {isMenuMobile,user,setAuth,setUser,setUserId,setNotes,setIsMenu,setIsMenuMobile} = useAuth()
...
const userSetting = () =>{
  ...
  return (
    <div className={!isMenuMobile ? 'mobile-mainmenu' : 'mobile-mainmenu active'}>
         <div className={!isMenuMobile ? 'mobile-menu-blur' : 'mobile-menu-blur active' }></div>
         <section className='mobile-menu-pane'>
            ...
            <ul className='mobile-menu-pane-body'>
               ...
               <div className='mobile-each-list'><img className='setofnotes' src={require('../../images/menuButtons/setofnotes.png')}/><p>Set of Notes</p></div>
